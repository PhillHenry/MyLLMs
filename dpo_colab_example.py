...
model_name = "HuggingFaceH4/ultrafeedback_binarized"
raw_datasets = get_datasets(
    {model_name: 0.005}, # 0.5% sampled
...
model.save_pretrained_merged(f"{SAVED_MODEL}/{model_name}", tokenizer=tokenizer, save_method="lora") # merged_4bit_forced